...
Keep this table aligned with the permission model in `../architecture/THREAT-MODEL.md`
...
- Renaming a domain term is a decision: record an ADR before the rename, not after.
