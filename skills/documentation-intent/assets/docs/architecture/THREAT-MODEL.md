...
Mirrors the roles in [../context/PRODUCT.md](../context/PRODUCT.md), at the resource level.
...
rewrite as optional cleanup — a rotation runbook in `operations/RUNBOOKS.md` belongs
there when that on-demand file exists.
