...
answer your question, and open only those. Do not load the whole `docs/` tree.

| You need | Go to |
| -------- | ----- |
| Domain vocabulary, user roles, business rules | `docs/context/PRODUCT.md` |
| Structure, entry points, where to add code | `docs/architecture/OVERVIEW.md` |
| Why something is the way it is | `docs/decisions/README.md` |
| How to run, test, deploy | `docs/operations/` |
...
2. `docs/decisions/README.md` — is there an accepted ADR constraining this work?
3. `docs/architecture/OVERVIEW.md` — invariants and extension points for the area you touch
...
| Structural or technology choice made | New ADR in `docs/decisions/` + index row |
| Structure, entry point, or invariant changed | `docs/architecture/OVERVIEW.md` |
| Domain term added or renamed | `docs/context/PRODUCT.md` glossary |
| Setup, command, or env variable changed | `docs/operations/DEVELOPMENT.md` |
